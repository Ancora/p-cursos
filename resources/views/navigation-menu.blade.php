...
<nav x-data="{ open: false }" class="border-b-2 border-blue-300 fixed w-full z-50 p-2 shadow-2xl" style="background-image: url({{asset('img/home/bg-app.png')}})">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img class="" src="{{asset('img/logoAncora152x054.png')}}" alt="Âncora Soluções em TI">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        <x-jet-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-500 bg-white hover:bg-blue-50 hover:text-blue-700 focus:outline-none focus:bg-blue-50 active:bg-blue-50 transition">
                ...
                <div class="ml-3 relative">
                    @auth
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                @else
                                    <span class="inline-flex rounded-md">
                                        <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-500 bg-white hover:text-blue-700 focus:outline-none transition">
                                            {{ Auth::user()->name }}
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="ml-4 text-lg text-blue-300 no-underline">Registrar-se</a>
                    @endauth
                </div>
            </div>
